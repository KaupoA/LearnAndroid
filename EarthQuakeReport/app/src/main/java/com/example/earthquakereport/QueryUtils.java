...
final class QueryUtils {
    ...
    public static List<QuakeReport> fetchEarthquakeData(String requestUrl) {
        ...
        List<QuakeReport> earthquake = extractEarthquakes(jsonResponse);
     ...
     */
    static List<QuakeReport> extractEarthquakes(String earthquakeJSON) {
        ...
        List<QuakeReport> earthquake = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                QuakeReport earthquakes = new QuakeReport(magnitude, location, date, url);

                earthquake.add(earthquakes);
            }
